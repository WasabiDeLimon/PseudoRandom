...
namespace ProyectoEquipo
{
    public partial class PruebaVolados : Form
    {
        ...
        private void btnjugar_Click(object sender, EventArgs e)
        {
            ...
            {
                lblVictoriaMagistral.Text = "No tienes ni buena ni mala suerte, si vas a las Vegas tal vez ganes algo, pero no es seguro\n:/ ";
            }
            else
            {
                lblVictoriaMagistral.Text = "Tienes una suerte pesima, ve a las Vegas y te mueres pobre\n:'( ";
            }
        }
